...
import com.wds.seelive.databinding.ItemDetailShareBinding;
...
public class ShareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public  class ShareHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            UMWeb web = new UMWeb(mShareData.getString(DetailsActivity.KEY_NEW_SHARE_LINK));
            web.setTitle(mShareData.getString(DetailsActivity.KEY_NEW_TITLE));//标题
            UMImage thumb = new UMImage(activity,mShareData.getString(DetailsActivity.KEY_NEW_IMAGE_URL));
            web.setThumb(thumb);  //缩略图
            web.setDescription(mShareData.getString(DetailsActivity.KEY_NEW_DESCRIPTION));//描述
