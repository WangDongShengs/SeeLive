...
import com.wds.seelive.databinding.FragmentDetailContentBinding;
import com.wds.seelive.detail.adapter.CommentAdapter;
import com.wds.seelive.detail.adapter.RelatedNewsAdapter;
import com.wds.seelive.detail.adapter.ShareAdapter;
...
public class DetailContentFragment extends MvpBaseFragment<IDetailConstraint.IDetailPresenter> implements IDetailConstraint.IDetailView {
    ...
    public void setArguments(@Nullable Bundle args) {
        ...
        if(args != null){
            contentUrl = args.getString(DetailsActivity.KEY_URL);
            mNewsId = args.getString(DetailsActivity.KEY_NEW_ID);
        }
    }
