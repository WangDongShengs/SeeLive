...
public interface Constrant {
    ...
    interface  URL{
        String LOGIN = "app/v_1_7_2/user/login2";//密码登录
        String CODE_LOGIN="app/v_1_7_2/user/login";//验证码登录
        String CODE="app/v_1_7_2/captcha/getcaptcha";//获取验证码
        String GET_USER = "/api/user/getuserinfo";
        String COLUMN_MANAGER = "/api/column/columnmanagelist";//tabLayout  专栏
